...
type Props = {
  ...
  setLoginStep: React.Dispatch<React.SetStateAction<ForgotPasswordStepType>>;
};

export default function UserForgotPasswordStep({
      ...
      >
        <div className={sharedStyles["container"]}>
          ...
          <button disabled={!canSubmit || isLoading}>
            {isLoading ? <IphoneLoader /> : dictionary.forgotPassword}
          </button>
