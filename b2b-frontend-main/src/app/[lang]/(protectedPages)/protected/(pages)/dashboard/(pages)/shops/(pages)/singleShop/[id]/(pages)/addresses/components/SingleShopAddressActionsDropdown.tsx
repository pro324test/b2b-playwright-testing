...
import DeleteShopAddressModal from "./modals/DeleteShopAddressModal";
import { ShopAddress } from "@/types/ourApiSepecifc/ShopAddress";
import EditShopAddressModal from "./modals/EditShopAddressModal";

type Props = {
  shopAddress: ShopAddress;
};

export default function SingleShopAddressActionsDropdown({
  shopAddress,
}: Props) {
  ...
  return (
    <>
      <DeleteShopAddressModal
        shopAddress={shopAddress}
        isOpen={isDeleteModalOpen}
        setIsOpen={setIsDeleteModalOpen}
      />
      <EditShopAddressModal
        shopAddress={shopAddress}
