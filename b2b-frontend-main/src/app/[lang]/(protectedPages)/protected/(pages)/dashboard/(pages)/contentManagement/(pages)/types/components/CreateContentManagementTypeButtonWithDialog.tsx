...
export default function CreateContentManagementTypeButtonWithDialog() {
  ...
  const handleSubmit = useCallback(async (data: object) => {
    setIsLoading(true);
    try {
      const response = await contentManagementTypesRequests.create({
        privateAxios,
        data,
      });
  ...
  return (
    <Dialog>
      ...
      >
        ...
        <span> Create Content Management Type</span>
      </DialogTrigger>
      <DialogContent className="min-w-[50%]" dir={websiteDirection}>
        <DialogHeader>
          <DialogTitle className="text-3xl text-center">
            Create Content Management Type
          </DialogTitle>
          <div>
