...
export default function EditPromotionOfBogoDifferentModal({
  isOpen,
  setIsOpen,
  promotion,
}: Props) {
  ...
  const [selectedCategories, setSelectedCategories] = useState<
    MultipleSelectorOption[]
  >(
    promotion.bogoRule.applicableCategories?.map((category) => ({
      label: category.name,
  ...
  const [selectedProductId, setSelectedProductId] = useState<number | null>(
    promotion.bogoRule.freeProductId ? promotion.bogoRule.freeProductId : null
  );
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-3xl text-center">
            Edit Promotion Of Bogo Different
          </DialogTitle>
          <div>
