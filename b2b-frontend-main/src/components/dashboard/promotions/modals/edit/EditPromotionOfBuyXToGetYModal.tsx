...
export default function EditPromotionOfBuyXToGetYModal({
  isOpen,
  setIsOpen,
  promotion,
}: Props) {
  ...
  const [discountPercent, setDiscountPercent] = useState(
    promotion.bogoRule.discountPercent == null
      ? ""
      : promotion.bogoRule.discountPercent.toString()
  );
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-3xl text-center">
            Edit Promotion of Buy X to Get Y
          </DialogTitle>
          <div>
