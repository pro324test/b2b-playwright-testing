            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-main-color",
                    "data-[fixed]:bg-muted-foreground data-[fixed]:text-muted hover-bg-darker-main-color",
                    badgeClassName
                  )}
                ...
                >
                  ...
                  <button
                    className={cn(
                      "ml-1 rounded-full outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2 bg-red-600",
                  ...
                  >
                    <X className="h-4 w-4 text-white hover:text-foreground" />
                  </button>
                </Badge>
              );
            })}
